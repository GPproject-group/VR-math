...
public class CreatePyramid : ScriptableWizard
{
    ...
    {
        ScriptableWizard.DisplayWizard("Create Pyramid", typeof(CreatePyramid));
    }

    void OnWizardCreate()
    {
        GameObject newCone = new GameObject("Pyramid");
